...
/* harmony import */ var _post_index__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./post-index */ "./blocks/post-index/index.js");
/* harmony import */ var _bullet__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./bullet */ "./blocks/bullet/index.js");
/* harmony import */ var _profile__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./profile */ "./blocks/profile/index.js");
/* harmony import */ var _stats__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./stats */ "./blocks/stats/index.js");
/* harmony import */ var _collapse__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./collapse */ "./blocks/collapse/index.js");
/* harmony import */ var _map__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./map */ "./blocks/map/index.js");
/* harmony import */ var _iter__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./iter */ "./blocks/iter/index.js");
/* harmony import */ var _warranty__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./warranty */ "./blocks/warranty/index.js");
/* harmony import */ var _hero__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./hero */ "./blocks/hero/index.js");
/* harmony import */ var _publication__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./publication */ "./blocks/publication/index.js");
/* harmony import */ var _grid__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./grid */ "./blocks/grid/index.js");
/* harmony import */ var _icon_paragraph__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./icon-paragraph */ "./blocks/icon-paragraph/index.js");
/* harmony import */ var _countdown__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./countdown */ "./blocks/countdown/index.js");
/* harmony import */ var _trust__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./trust */ "./blocks/trust/index.js");
/* global wp */
...
_testimonial__WEBPACK_IMPORTED_MODULE_4__, _testimonial_embed__WEBPACK_IMPORTED_MODULE_6__, _testimonial_list_index__WEBPACK_IMPORTED_MODULE_5__, _testimonial_rating__WEBPACK_IMPORTED_MODULE_8__, _testimonial_author__WEBPACK_IMPORTED_MODULE_7__, _product_price__WEBPACK_IMPORTED_MODULE_9__, _product_addtocart__WEBPACK_IMPORTED_MODULE_10__, _product_rating__WEBPACK_IMPORTED_MODULE_12__, _product_stock__WEBPACK_IMPORTED_MODULE_11__, _call_us__WEBPACK_IMPORTED_MODULE_13__, _card__WEBPACK_IMPORTED_MODULE_14__, _icon__WEBPACK_IMPORTED_MODULE_15__, _post_index__WEBPACK_IMPORTED_MODULE_16__, _bullet__WEBPACK_IMPORTED_MODULE_17__, _profile__WEBPACK_IMPORTED_MODULE_18__, _stats__WEBPACK_IMPORTED_MODULE_19__, _collapse__WEBPACK_IMPORTED_MODULE_20__, _map__WEBPACK_IMPORTED_MODULE_21__, _iter__WEBPACK_IMPORTED_MODULE_22__, _warranty__WEBPACK_IMPORTED_MODULE_23__, _hero__WEBPACK_IMPORTED_MODULE_24__, _publication__WEBPACK_IMPORTED_MODULE_25__, _grid__WEBPACK_IMPORTED_MODULE_26__, _icon_paragraph__WEBPACK_IMPORTED_MODULE_27__, _countdown__WEBPACK_IMPORTED_MODULE_28__, _trust__WEBPACK_IMPORTED_MODULE_29__].forEach(function (block) {
  if (!block) {
    return;
  }
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(PostIndexEdit, _Component);

  function PostIndexEdit(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, PostIndexEdit);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(PostIndexEdit).apply(this, arguments));
    _this.updateAnchor = _this.updateAnchor.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.addAnchor = _this.addAnchor.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.removeAnchor = _this.removeAnchor.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(PostIndexEdit, [{
    key: "addAnchor",
    value: function addAnchor() {
      var _this$props = this.props,
          anchors = _this$props.attributes.anchors,
          setAttributes = _this$props.setAttributes;
      var updatedAnchors = anchors.slice(0);
      updatedAnchors.push({
        text: '',
        url: ''
      });
    ...
    key: "removeAnchor",
    value: function removeAnchor(index) {
      var _this$props2 = this.props,
          anchors = _this$props2.attributes.anchors,
          setAttributes = _this$props2.setAttributes;
      anchors.splice(index, 1);
      setAttributes({
        anchors: anchors.slice(0)
      });
    }
  }, {
    key: "updateAnchor",
    value: function updateAnchor(index, update) {
      var _this$props3 = this.props,
          anchors = _this$props3.attributes.anchors,
          setAttributes = _this$props3.setAttributes;
      var updatedAnchors = anchors.slice(0);
      var updatedAnchor = Object.assign({}, anchors[index], update);
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          className = _this$props4.className,
          isSelected = _this$props4.isSelected;
      var anchors = attributes.anchors,
          title = attributes.title;
      var classNames = classnames__WEBPACK_IMPORTED_MODULE_7___default()(className, {
        'is-selected': isSelected
      });
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        className: classNames
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(RichText, {
        tagName: 'h3',
        value: title,
        onChange: function onChange(value) {
          return setAttributes({
        ...
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
          className: 'wp-block-svbk-index__anchor',
          key: index
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(RichText, {
          tagName: 'p',
          value: anchor.text,
          onChange: function onChange(value) {
            return _this2.updateAnchor(index, {
              text: value
            });
          },
          ...
          className: 'wp-block-svbk-index__edit'
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(ButtonGroup, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Button, {
          isDestructive: true,
          className: 'wp-block-svbk-index__remove',
          onClick: function onClick() {
            _this2.removeAnchor(index);
          }
        }, __('Remove', '_svbk')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Button, {
          isPrimary: true,
          className: 'wp-block-svbk-index__add',
          onClick: _this2.addAnchor
        }, __('Add', '_svbk')))));
      })));
    }
  }]);

  return PostIndexEdit;
}(Component);

/* harmony default export */ __webpack_exports__["default"] = (PostIndexEdit);

/***/ }),

/***/ "./blocks/post-index/index.js":
/*!************************************!*\
  !*** ./blocks/post-index/index.js ***!
  \************************************/
/*! exports provided: name, settings */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./blocks/post-index/edit.js");
...
var name = 'svbk/post-index';
var settings = {
  title: __('Index', '_svbk'),
  icon: 'editor-ul',
  category: 'common',
  keywords: [__('index', '_svbk'), __('article', '_svbk'), __('post', '_svbk'), __('content', '_svbk')],
  attributes: {
    title: {
      type: 'string',
      source: 'text',
  ...
  save: function save(_ref) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(RichText.Content, {
      ...
      className: 'wp-block-svbk-index__title',
      value: title
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", null, anchors.map(function (anchor, index) {
